...
<nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="#portfolio">Book Tours</a></li>
          <li><a href="#contact">Contact</a></li>
          <li><a href="#team">FAQ</a></li>
          <li><a href="Login.jsp" class="active">Login In/Sign Up</a></li>
...
<!-- ======= Contact Section ======= -->
    <section id="contact" class="contact">
      ...
      <c:set var="loginSuccessful" value='${requestScope["LoginSuccessful"]}' />
    <c:out value="${message}"/> 
Done!!


    <c:set var="loginSuccessful" scope="request" value="LoginSuccessful" />
