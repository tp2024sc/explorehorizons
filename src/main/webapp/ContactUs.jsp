...
<nav id="navbar" class="navbar">
  ...
  <main id="main">
    ...
    <div class="text-center">
      <h5 class="mb-4">Our address is at 103 Adam Street.</h5>
      <h5 class="mb-4">Our office hours (Mon-Sat): 10am - 700pm </h5>
      <h5 class="mb-4">Our office number:+44 1234567890 </h5>
...
<section id="contact" class="contact">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <form action="EmailServlet" method="post" role="form" class="php-email-form">
          <div class="row">
